...
This file explains how to use [user_specific_climate_data_template.csv](D:/MyFiles/R-dev/wisdm_v2/risk-modelling-and-mapping/src/user_specific_climate_data_template.csv) with the climate-model workflow.

## Purpose

Use the CSV template when you want to bypass the hard-coded CHELSA climate inputs and provide your own climate rasters to `03_fit_climate_model.R`.
...
- `period`: one of `current`, `2041-2070`, or `2071-2100`
- `scenario`: one of `current`, `ssp126`, `ssp370`, or `ssp585`
...
1. Copy and edit [user_specific_climate_data_template.csv](D:/MyFiles/R-dev/wisdm_v2/risk-modelling-and-mapping/src/user_specific_climate_data_template.csv).
...
4. Set the configuration in [00_configurations.R](D:/MyFiles/R-dev/wisdm_v2/risk-modelling-and-mapping/src/00_configurations.R:24):
...
- Every predictor listed under `current,current` must also be present in each future period/scenario block.
