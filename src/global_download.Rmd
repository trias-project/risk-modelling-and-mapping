...
taxa_input_file <-"C:/Users/amyjs/Documents/projects/Trias/risk_modelling/data/external/PRA/pra_birds.csv"
...
```
#paste key from above or get from gbif_downloads. tsv
# create directory for PRA files in windows with subfolder for gbif_speciesFiles and set directory path in r

# retrieves download from GBIF 
occ_download_get("0110919-200613084148143", path = "C:/Users/amyjs/Documents/projects/Trias/risk_modelling/data/raw")

#unzip folder via Windows directory, then read.csv
occ<-read.delim("//192.168.1.48/data/Trias/risk_modelling/data/external/raw/0110919-200613084148143/occurrence.txt",header=TRUE)
