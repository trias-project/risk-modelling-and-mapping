...
####remove these before sending to github
species<- "Campylopus introflexus"
GBIF_taxonkey<- "5281901"
...
global <- read.csv(file = here("data", "external", "PRA", "PRA_Plants", "gbif_speciesFiles", gbif_filename))
...
global_points<-randomPoints(biasgrid_sub, numb.pseudoabs, global.occ.sp, ext=NULL, extf=1.1, excludep=TRUE, prob=FALSE,
                                cellnumbers=FALSE, tryf=70, warn=2, lonlatCorrection=FALSE) #will throw a warning if randomPoints generated is less than numb.pseudoabs. If this happens, increase the number of tryf.
```
