...
if (!dir.exists(folder_path)) {
  ...
  message(paste0("Folder '",project,"' created in './data/projects' 🎉"))
} else {
 message(paste0("Folder '",project,"' already exists in './data/projects' 🎉"))
}
```
...
rm(list = setdiff(ls(), c("global", "taxa_input_file", "accepted_taxonkeys")))
```
