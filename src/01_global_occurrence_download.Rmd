...
species<-c("Anthaxia costifera","Vespa citriventris")
...
taxonkeys<-c(accepted_taxonkeys, synonym_taxonkeys)
...
#Remove objects 
remove(mapped_taxa, not_accepted, taxon_df, accepted_taxonkeys, synonyms_taxonkeys)
